...
void setup() {
  ...
  server.on("/", HTTP_GET, [](AsyncWebServerRequest *request) {
    ...
    html += "<div class='form-row'>";
    html += "<div class='form-group'><label class='form-label'>Host/IP</label>";
    html += "<input type='text' id='serviceHost' class='form-input'></div>";
    html += "<div class='form-group'><label class='form-label'>Port</label>";
    html += "<input type='number' id='servicePort' class='form-input' value='80'></div></div>";
    html += "<div class='form-group'><label class='form-label'>URL/Path</label>";
    html += "<input type='text' id='serviceUrl' class='form-input' placeholder='/api/health'></div>";
    html += "<div class='form-group'><label class='form-label'>Expected Response</label>";
    ...
    html += "document.getElementById('serviceEnabled').value=s.enabled;";
    html += "document.getElementById('serviceHost').value=s.host;";
    html += "document.getElementById('servicePort').value=s.port;";
    ...
    html += "port:parseInt(document.getElementById('servicePort').value),";
