...
if _ota_raw in ["2", "delayed"]:
    _ota_val = "2"
elif _ota_raw in ["true", "1", "yes", "on"]:
    _ota_val = "1"
else:
    _ota_val = "0"
...
# Tri-state AUTO_OTA_ENABLED (0=off, 1=on, 2=delayed)
env.Append(CPPDEFINES=[("AUTO_OTA_ENABLED", _ota_val)])
...
# Tri-state AUTO_OTA_ENABLED
header_lines.append(f'#define AUTO_OTA_ENABLED {_ota_val}')
